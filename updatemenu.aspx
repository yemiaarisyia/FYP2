<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updatemenu.aspx.cs" Inherits="FYP2.updatemenu" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="center-container">
            <div class="form-container">
                ...
                <asp:Button ID="Button2" runat="server" Text="Cancel" CssClass="btn btn-secondary" OnClick="Button2_Click" />
            </div>
        </div>
    </form>
</body>
